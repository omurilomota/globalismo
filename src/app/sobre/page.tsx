  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <article className="prose prose-lg max-w-none">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Sobre o Globalismo</h1>
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Temas Abordados</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Nossa Abordagem</h2>
        <p className="text-gray-600 mb-6">
        ...
        <div className="bg-gray-100 p-6 rounded-lg mt-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Contribua</h3>
